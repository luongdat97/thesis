...
import { Form, Input, Button, Select, Row, Col, Collapse, Card, Typography, Space, message } from 'antd';
                    ...
                    <div>
                        ...
                        <div className="pt-3">
                            <div className="d-flex justify-content-center">
                                <Button onClick={() => message.warn("Bạn cần đăng nhập để sử dụng chức năng này")} size="large" type="primary" style={{ background: "#73d13d", borderColor: "#73d13d" }}>Ứng tuyển ngay</Button>
                            </div>
