    ...
    return (
        <>
            <div style={{ backgroundColor: "#f0f2f5" }}>
                <StyleCv>
                    <Title level={3}>Cập nhật cá nhân</Title>
                    <Row gutter={30}>
                        <Col>
                                    ...
                                    <Row className="h-100">
                                        <Col span={7} className="px-0 input-none-bg text-white" style={{ background: "#37474f" }}>
                                            ...
                                            <div className="p-2 mt-3">
                                                ...
                                                <div className="section mt-3" style={{ display: display.objective ? "block" : "none" }}>
                        ...
                        <Col sm={7}>
                            <div className="mb-3">
                                <Space>
                                    <ChangeCv init={() => setCv(form.getFieldsValue())} initial={{ cv, avatar, display }} cvType={0} actionType="update" cvID={id} />
