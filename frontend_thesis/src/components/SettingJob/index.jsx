...
const SettingJob = (props) => {
    return (
        <>
            <Title level={2}>CẬP NHẬT THÔNG TIN GỢI Ý VIỆC LÀM</Title>
            TẠI SAO BẠN NÊN CẬP NHẬT THÔNG TIN GỢI Ý VIỆC LÀM?

TopCV là nền tảng kết nối cơ hội việc làm thông qua CV đầu tiên tại Việt Nam, nơi mà ứng viên sẽ được Nhà tuyển dụng chủ động săn đón.

Cập nhật thông tin chi tiết ngay, nếu bạn muốn:

Được nhà tuyển dụng chủ động săn đón.
Được gợi ý các cơ hội việc làm phù hợp.
            <Row>
                <Col xs={16}>
...
const Demo = () => {
    ...
    return (
        ...
        >
            ...
            <Title level={3}>Kinh nghiệm thực tế</Title>
            <Form.Item
                label="Ngành nghề"
                name="password"
            >
            ...
            <Title level={3}>Mong muốn của bạn</Title>
            <Form.Item
